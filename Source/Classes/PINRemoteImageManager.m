                        ...
                        UUID:(NSUUID *)UUID
{
    ...
    [task scheduleDownloadWithRequest:[self requestWithURL:url task:task requestModifier:requestModifier]
                               resume:resume
...
- (NSURLRequest *)requestWithURL:(NSURL *)url task:(PINRemoteImageTask *)task requestModifier:(PINRemoteImageManagerRequestModifier)requestModifier
{
